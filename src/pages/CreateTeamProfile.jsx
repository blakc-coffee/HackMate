...
export function CreateTeamProfile (){
    ...
    return(
        ...
        <form className="profile-form">
            ...
            <div className="form-section">
                ...
                <div className="type-selector">
                    <label className="type-option active">
                        <input type="radio" name="type" value="solo"  
            ...
            <div className="form-section">
                <h2 className="form-section-title">Skills * <span className="hint">
                    Select at least 1 (max 5)</span></h2>
            ...
            <div className="form-section">
                ...
                <div className="form-group">
                    <input type="text" name="workingOn" 
            ...
            <div className="form-actions">
                ...
                onClick={<CreateNewProfile type="team" />}>
